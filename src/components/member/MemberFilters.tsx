    ...
    <Card>
      <CardContent className="p-6">
        <div className="space-y-4">
            ...
            <div>
              ...
              <Select value={filterCategory} onValueChange={setFilterCategory}>
                ...
                <SelectContent>
                  ...
                  {isAcademicInstitution && <SelectItem value="Student">Student</SelectItem>}
                  {isAcademicInstitution && <SelectItem value="Teaching Staff">Teaching Staff</SelectItem>}
          ...
          {/* Second row - Academic filters for School */}
          {isSchool && (
          ...
          {/* Second row - Academic filters for College */}
          {isCollege && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
          ...
          {/* Non-academic institution filters */}
          {!isAcademicInstitution && (
          ...
          {/* Date filters - Always on bottom row */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
